...
@if errorlevel 1 goto lbl_err
%rgbenv%rgbasm -oobj/sgb_gfx.o -Wno-obsolete -p 0xFF -isrc/ -ires/ -i./common/ -i./gfx_im/ src/sgb_gfx.asm
@if errorlevel 1 goto lbl_err
...
@if errorlevel 1 goto lbl_err
%rgbenv%rgblink -t -w -p0xFF -o bin/sgbdumper.gb -m bin/sgbdumper.map -n bin/sgbdumper.sym obj/sgbdumper.o obj/sgb_comm.o obj/util.o obj/sgb.o obj/sgb_gfx.o
@if errorlevel 1 goto lbl_err
